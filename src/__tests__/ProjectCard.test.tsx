...
describe('ProjectCard', () => {
  it('renders with the project title and number of stars', () => {
    ...
    expect(
      within(projectCardElement).queryByText(projectMockData.name)
    ).toBeTruthy()
    expect(within(projectCardElement).getAllByTestId('star')).toHaveLength(
      projectMockData.rating
    )
  })
